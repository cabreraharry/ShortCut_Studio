...
// shadcn/ui DropdownMenu primitive — Radix wrapper that gives us
// outside-click close, Escape close, full keyboard nav, aria roles, and
// portal rendering for free. Replace open-coded chip menus with this so
